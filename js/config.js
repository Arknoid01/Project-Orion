...
const BUILDING_DEFS = {
  ...
  farm:      { name:'building.farm',      icon:'🌾', color:'#c9a227', validTerrain:'wheat',  produces:'wheat',  rate:0, isSeasonalCrop:true, cost:50, upkeep:0.3, workers:5, sprite:'assets/buildings/farm.png', spriteOffsetX:-4, spriteOffsetY:-7 },
  quarry:    { name:'building.quarry',    icon:'⛏️', color:'#9aa5ab', validTerrain:'marble', produces:'marble', rate:1.1, sprite:'assets/buildings/quarry.png', spriteOffsetX:-4, spriteOffsetY:-7, cost:60, upkeep:0.3, workers:5 },
  ...
  winery:    { name:'building.winery',    icon:'🍷', color:'#7d2b46', validTerrain:'grass',  consumes:{grapes:1}, produces:'wine',      rate:1.05, sprite:'assets/buildings/winery.png', spriteOffsetX:-4, spriteOffsetY:-7, cost:70, upkeep:0.3, workers:5 },
  weaver:    { name:'building.weaver',    icon:'🧵', color:'#9a8b72', validTerrain:'grass',  consumes:{wool:1},   produces:'clothing', rate:0.95, sprite:'assets/buildings/weaver.png', spriteOffsetX:-4, spriteOffsetY:-7, cost:80, upkeep:0.3, workers:5 },
  foundry:   { name:'building.foundry',   icon:'🔥', color:'#8b6914', validTerrain:'grass',  consumes:{coal:1, marble:0.4}, produces:'bronze', rate:0.9, sprite:'assets/buildings/foundry.png', spriteOffsetX:-4, spriteOffsetY:-7, cost:110, upkeep:0.6, workers:6 },
  armory:    { name:'building.armory',    icon:'🗡️', color:'#5c6b7a', validTerrain:'grass',  consumes:{bronze:1, clothing:0.5}, produces:'arms', rate:0.85, cost:140, upkeep:0.6, workers:7, isArmory:true, sprite:'assets/buildings/armory.png', spriteOffsetX:-4, spriteOffsetY:-7 },
  // ---- Stockage ----
  granary:   { name:'building.granary',   icon:'🏺', color:'#8a5a3b', validTerrain:'grass',  storageBonus:{wheat:150, carrots:80, meat:60}, sprite:'assets/buildings/granary.png', spriteOffsetX:-4, spriteOffsetY:-7, cost:40, upkeep:0.3 },
  warehouse: { name:'building.warehouse', icon:'📦', color:'#9c7b4a', validTerrain:'grass',  storageBonus:{ marble:40, sculpture:30, olives:80, oil:100, grapes:80, wine:100, wool:80, clothing:60, fish:60, carrots:50, meat:45, coal:50, bronze:40, arms:30 }, sprite:'assets/buildings/warehouse.png', spriteOffsetX:-4, spriteOffsetY:-7, cost:50, upkeep:0.3 },
  // ---- Commerce extérieur ----
  // Exporte chaque mois les marchandises sélectionnées (voir trade.js). Plusieurs
  // comptoirs cumulent leur débit d'export.
  tradingPost:{ name:'building.tradingPost', icon:'⚖️', color:'#b08d57', validTerrain:'grass', isTradePost:true, cost:125, upkeep:0.6, workers:4, sprite:'assets/buildings/tradingPost.png', spriteOffsetX:3, spriteOffsetY:-7 },
  // ---- Marine (Phase 6) : port côtier + chantier naval ----
  harbor:    { name:'building.harbor',    icon:'⚓', color:'#3d7a9e', validTerrain:'grass', requiresNearWater:true, isHarbor:true, cost:110, upkeep:0.5, workers:3, sprite:'assets/buildings/harbor.png', spriteOffsetX:-4, spriteOffsetY:-7 },
  shipyard:  { name:'building.shipyard',  icon:'🚢', color:'#5a6a7a', validTerrain:'grass', requiresNearHarbor:true, isShipyard:true, cost:140, upkeep:0.6, workers:5, sprite:'assets/buildings/shipyard.png', spriteOffsetX:-4, spriteOffsetY:-7 },
  ...
  watchtower:{ name:'building.watchtower',icon:'🗼', color:'#a05a3a', validTerrain:'grass',  isService:true, serviceType:'fire',     range:18, capacity:12, cost:105, upkeep:0.6, sprite:'assets/buildings/watchtower.png', spriteOffsetX:-4, spriteOffsetY:-7 },
  // ---- Culture (Phase 1) : agora = walker ; théâtre/gymnase/stoa/académie = lieux sur le réseau ----
  agora:     { name:'building.agora',     icon:'🏛️', color:'#c4a882', validTerrain:'grass',  isService:true, serviceType:'culture',  range:18, capacity:14, cost:95,  upkeep:0.5, sprite:'assets/buildings/agora.png?v=2', spriteOffsetX:-4, spriteOffsetY:-7 },
  theatre:   { name:'building.theatre',   icon:'🎭', color:'#b87a8a', validTerrain:'grass',  isVenue:true, venueKind:'theatre',   beauty:4, range:3, cost:120, upkeep:0.6, sprite:'assets/buildings/theatre.png?v=2', spriteOffsetX:-4, spriteOffsetY:-7 },
  gymnasium: { name:'building.gymnasium', icon:'🏟️', color:'#8a9a6a', validTerrain:'grass',  isVenue:true, venueKind:'gymnasium', beauty:3, range:2, cost:110, upkeep:0.55, sprite:'assets/buildings/gymnasium.png?v=2', spriteOffsetX:8, spriteOffsetY:-10 },
  stoa:      { name:'building.stoa',      icon:'🏺', color:'#d4cbb8', validTerrain:'grass',  isVenue:true, venueKind:'stoa',      beauty:3, range:2, cost:85,  upkeep:0.4, spriteScale:112, spriteOffsetX:-22, spriteOffsetY:-10, sprite:'assets/buildings/stoa.png?v=4' },
  academy:   { name:'building.academy',   icon:'📜', color:'#7a8aa8', validTerrain:'grass',  isVenue:true, venueKind:'academy',   beauty:4, range:2, cost:115, upkeep:0.55, sprite:'assets/buildings/academy.png?v=2', spriteOffsetX:-4, spriteOffsetY:-7 },
  // ---- Habitation ----
  maison:    { name:'building.maison',    icon:'🏠', color:'#c9b68f', validTerrain:'grass',  isHouse:true, cost:30, spriteOffsetX:-4, spriteOffsetY:-7 },
  // ---- Décorations : diffusent du "cachet" (beauty) autour d'elles (voir beauty.js) ----
  statue:    { name:'building.statue',    icon:'🗿', color:'#cdc7ba', validTerrain:'grass', isDecoration:true, beauty:6, range:2, cost:60, upkeep:0.3, sprite:'assets/buildings/statue.png', spriteOffsetX:30, spriteOffsetY:-12 },
  garden:    { name:'building.garden',    icon:'🌳', color:'#6f9a4c', validTerrain:'grass', isDecoration:true, beauty:4, range:3, cost:40, sprite:'assets/buildings/garden.png', spriteOffsetX:-4, spriteOffsetY:-7 },
  colonnade: { name:'building.colonnade', icon:'🏛️', color:'#e3ddcf', validTerrain:'grass', isDecoration:true, beauty:5, range:2, cost:50, upkeep:0.3, sprite:'assets/buildings/colonnade.png', spriteOffsetX:-3, spriteOffsetY:-22 },
...
/* ===================== SPRITES BÂTIMENTS ===================== */
// Chaque bâtiment utilise son PNG homonyme dans assets/buildings/ (voir BUILDING_DEFS.sprite).
...
const MARKET_GOODS = [
  ...
  { need:'food', resource:'carrots', perHouse:1 },
  { need:'food', resource:'meat', perHouse:1 },
...
const EXPORT_GOODS = [
  ...
  { resource:'carrots',   price:5 },
  { resource:'meat',      price:8 },
...
const TROOPS_PER_BARRACKS = 24;   // points de troupe soutenus par caserne
const TROOPS_PER_POP = 0.35;       // plafond lié à la population (35 % des habitants)
const ARMY_UPKEEP_GOLD = 1.55;    // drachmes/mois par point de troupe
const ARMY_UPKEEP_WHEAT = 2.0;    // blé/mois par point de troupe
const ARMY_UPKEEP_ARMS = 0.12;    // armes/mois par point de troupe (armurerie)
...
const WORLD_CITY_BASE_POWER = 58;        // puissance de référence
...
// Phase 5 — IA rivale : cités voisines avec personnalité, croissance et actions proactives.
const RIVAL_AI_ENABLED = true;
const RIVAL_ACTION_INTERVAL_DAYS = 6;
const RIVAL_FIRST_ACTION_DAY = 6;
const RIVAL_POWER_GROWTH_CAP = 130;
const RIVAL_INVASION_CHANCE = 0.17;
const RIVAL_DIPLOMAT_GIFT_CHANCE = 0.20;  // Sprint 4 — moins d'injection gratuite d'or
const RIVAL_DIPLOMAT_GIFT_MIN = 12;
const RIVAL_DIPLOMAT_GIFT_MAX = 28;
const RIVAL_PERSONALITIES = ['aggressive', 'merchant', 'diplomat'];

// Phase 6 — Marine : port, trirèmes, raids navals et bonus commerce.
const NAVAL_ENABLED = true;
const SHIP_POWER_EACH = 8;
const SHIP_BUILD_COST_GOLD = 155;
const SHIP_BUILD_COST_BRONZE = 3;
const FLEET_UPKEEP_GOLD = 10;
const HARBOR_EXPORT_BONUS = 2;
const NAVAL_EXPORT_BONUS_PER_SHIP = 1;
const NAVAL_TRADE_INCOME_BONUS = 0.04;
const NAVAL_RAID_MIN_SHIPS = 2;
const NAVAL_RAID_GOLD_WIN = 120;
const NAVAL_RIVAL_RAID_CHANCE = 0.18;
const NAVAL_RIVAL_RAID_MIN_DAY = 12;
const SHIPS_PER_HARBOR = 4;
const SHIPS_PER_SHIPYARD = 3;
const TRIPREME_SPRITE_PATH = 'assets/ships/trireme.png';
const SHIP_SPRITE_W = Math.round(TILE_W * 1.35);   // trirème ancrée sur case d'eau
const NAVAL_MAX_VISIBLE_SHIPS = 10;                // plafond rendu (fleet.ships peut être plus grand)

// Carte du monde (panneau latéral) — fond Méditerranée + repères colonies.
const WORLD_MAP_BG = 'assets/world/worldMap.png';
const WORLD_MAP_HOME = { x: 0.48, y: 0.50, labelKey: 'world.homeCity' };
...
const BASE_CAP = {
  wheat:60, carrots:50, meat:45, marble:60, sculpture:30, olives:45, oil:45, grapes:45, wine:45, wool:45,
...
const STARTING_RESOURCES = {
  wheat:35, carrots:8, meat:4, marble:20, sculpture:2, olives:12, oil:10, grapes:12, wine:6, wool:6,
...
//   decent    -> +eau
//   villa     -> +nourriture, +culture (agora + lieu culturel)
//   domaine   -> +huile, +beauté, +culture
//   residence -> +vin, +religion, +culture
...
const HOUSE_LEVELS = [
  ...
  { key:'villa',     nameKey:'houseLevel.villa',     population:15, requires:['route','water','food','culture'], sprite:'assets/houses/villa.png' },
  { key:'domaine',   nameKey:'houseLevel.domaine',   population:24, requires:['route','water','food','oil','culture','beauty'], sprite:'assets/houses/domaine.png' },
  { key:'residence', nameKey:'houseLevel.residence', population:34, requires:['route','water','food','oil','wine','fish','religion','culture','beauty'], sprite:'assets/houses/residence.png' },
  { key:'palais',    nameKey:'houseLevel.palais',    population:48, requires:['route','water','food','oil','wine','fish','clothing','religion','health','fire','culture','beauty'], sprite:'assets/houses/palais.png' },
];
...
const MIGRANT_MOVE_EVERY_TICKS = 1;   // intervalle de base entre deux cases (voir migrationAgents.js)
const MIGRANT_SPEED_MULTIPLIER = 1.5; // +50 % vitesse des colons entrant / sortant
...
const INVASION_SPAWN_CHANCE = 0.0035;
...
const MAP_FOREST_SPREAD_CHANCE = 0.38;     // extension organique des bosquets
...
const MAP_START_MIN_FOREST = 8;
const MAP_START_MIN_MARBLE = 4;
...
// Livraison « style Zeus » : une maison éligible n'est servie que si le walker passe
...
const SERVICE_WALKER_SPRITES = {
  ...
  culture:  'assets/characters/walkers/culture.png',
};
...
const WALKER_DIRECTION_ROWS = { up: 0, left: 1, right: 2, down: 3 };
// Planche walkers (288×384) : ligne 0 = dos · 1 = gauche · 2 = droite · 3 = face
...
/** Spectacles / compétitions dans les lieux culturels (venues.js). */
const VENUE_EVENT_COST = { wine: 4, sculpture: 2 };
const VENUE_EVENT_DURATION_TICKS = 45;
const VENUE_EVENT_GROWTH_BONUS = 0.08;
const VENUE_EVENT_MIN_SERVED = 2;
const VENUE_EVENT_CHANCE = 0.32;
...
/** Cultures saisonnières : 2 récoltes/an (début de mois attique), pas de production au tick. */
